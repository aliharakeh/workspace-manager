...
let broadcast: ((appId: number, event: RunnerEvent) => void) | null = null

export function setRunnerBroadcast(
  fn: (appId: number, event: RunnerEvent) => void
) {
  broadcast = fn
}
